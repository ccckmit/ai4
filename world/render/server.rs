...
/// CartPole state frames to connected browsers.
...
impl RenderServer {
    ...
    /// Broadcast a JSON frame to all connected WebSocket clients.
...
fn open_browser(port: u16) {
    ...
    let cmd = if cfg!(target_os = "macos") {
        ...
        return; // Windows / other — skip auto-open
    };
