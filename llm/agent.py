#!/usr/bin/env python3
"""llm/agent.py - AI Agent with memory and tool feedback"""
...
def build_context() -> str:
    """Build context from memory and conversation history."""
...
def update_memory(user_input: str, assistant_response: str, tool_result: Optional[str] = None) -> None:
...
async def extract_key_info(user_input: str, assistant_response: str) -> None:
    """Extract key info from conversation using LLM."""
